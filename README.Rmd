...
if (x$es_ver() < 600) {
  ...
  shakespeare <- system.file("examples", "shakespeare_data_notypes.json", package = "elastic")
}
```
...
gbifdat <- system.file("examples", "gbif_data_notypes.json", package = "elastic")
...
gbifgeo <- system.file("examples", "gbif_geo_notypes.json", package = "elastic")
